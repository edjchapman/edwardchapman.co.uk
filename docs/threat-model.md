...
| ------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| Secret leakage                             | Worker/Actions secrets; ggshield pre-commit scan; no `.dev.vars` committed; structured logs never carry keys                                                                                                                                                                                                                                                                            | Local `~/.secrets` file depends on machine hygiene (transcript-exposed token rolled 2026-07-13, old secret invalidated) |
