...
- **Never invent professional claims.** Every statement about Ed's work must
  ...
  or be Ed-approved positioning material drafted under the ADR-0011 workflow.
...
- **Never ingest private material uninvited.** Private notes, recruiter
  ...
  `career-portfolio` repo may be read to draft public-safe positioning copy
  under the reviewed workflow in `docs/content-policy.md` (ADR-0011) — every
  CV-derived claim listed in the PR description for Ed's approval, prohibited
  information still absolute. `docs/content-policy.md` is authoritative;
